...
class DeviceIdentity(context: Context) {
    ...
    companion object {
        ...
        private const val PREFS_NAME = "jsos_device_identity"
    ...
    init {
        ...
        Log.d(TAG, "Device identity ready")
        Log.d(TAG, "Public key initialized (${rawPublicKey.size} bytes)")
    }
    ...
    fun signAuthPayload(
        ...
        Log.d(TAG, "Signing auth payload")
        val sig = sign(payload.toByteArray(Charsets.UTF_8))
        Log.d(TAG, "Auth payload signed")
        return sig
    }

...
The APKs are signed preview builds. If a device already has a debug or self-built JSOS app installed with the same package name but a different signing key, Android may require uninstalling the old app first.

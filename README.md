...
<p align="center">
  <a href="https://github.com/IWhatsskill/JSOS/releases/tag/v2.0.29-watch-realtime-logo"><strong>Download preview APKs</strong></a>
  &nbsp;|&nbsp;
...
1. Download the latest JSOS Core, JSOS HUD, and optional JSOS Watch APKs from the [current preview release](https://github.com/IWhatsskill/JSOS/releases/tag/v2.0.29-watch-realtime-logo).
